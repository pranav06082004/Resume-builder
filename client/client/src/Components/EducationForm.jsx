                    ...
                    {data.map((education, index) => (
                        <div key={index} className="p-4 border-gray-300 rounded-lg space-y-3">
                            ...
                            <div className='grid md:grid-cols-2 gap-3'>
                                ...
                                <input value={education.graduation_date || ""} onChange={(e) => updateEducation(index, "graduation_date", e.target.value)} type="month" disabled={education.is_current} placeholder="End Date" className="px-3 py-2 text-sm rounded-lg" />
