...
const MinimalImageTemplate = ({ data, accentColor, removeBackground }) => {
    ...
    const getImageUrl = (image) => {
        ...
        const baseUrl = typeof image === 'string' ? image : URL.createObjectURL(image);
        if (typeof image === 'string') {
            return `${baseUrl}?tr=w-300,h-300,fo-face,z-0.75${removeBackground ? ',e-bgremove' : ''}`;
        }
        return baseUrl;
    };
            ...
            <div className="grid grid-cols-3">
                ...
                <div className="col-span-1  py-10">
                    ...
                    {data.personal_info?.image && (
                        <div className="mb-6">
                            <img src={getImageUrl(data.personal_info.image)} alt="Profile" className="w-32 h-32 object-cover rounded-full mx-auto" style={{ background: removeBackground ? 'white' : accentColor+'70' }} />
                        </div>
                    )}
                </div>
